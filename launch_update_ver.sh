...
curl --data '{"tag_name": "3.2.${new_minor_version}","target_commitish": "master","name": "3.2.${new_minor_version}","body": "example.com","draft": false,"prerelease": false}' https://api.github.com/repos/vtjarve/hello-world/releases?access_token=e64a2c6447a56857921c1ab22e3e58bd78ef0008
